...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  /* sorted atom table (offset=769) */
  JS_VALUE_ARRAY_HEADER(229),
  ...
  /* global object properties (offset=2185) */
