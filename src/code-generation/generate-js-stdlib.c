 ...
 * the build host to produce include/js-stdlib-table.h.
 * This header is automatically generated by the CMake build process.
 *
 * It is based on the Micro QuickJS REPL library
 * which is distibuted under the MIT License.
 *
